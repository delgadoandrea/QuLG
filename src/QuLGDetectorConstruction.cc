...
G4VPhysicalVolume* QuLGDetectorConstruction::Construct(){
 ...
 //-------------------------------------------------------------
  ...
  //-------------------------------------------------------------  
   ...
   new G4PVPlacement(nullptr,G4ThreeVector(0,0,scint_height/2.+box_front_cap_thick/2.),extra_reflector_log,"extra_reflector_phys",scint_log,false,0,true);
   G4PVPlacement* extra_reflector_phys_2 = 
   new G4PVPlacement(nullptr,G4ThreeVector(0,0,-scint_height/2.-box_front_cap_thick/2.),extra_reflector_log,"extra_reflector_phys",scint_log,false,0,true);

   G4PVPlacement* extra_reflector_inside_phys= 
   new G4PVPlacement(nullptr,{0,0,0},extra_reflector_inside_log,"extra_reflector_inside_phys",extra_reflector_log,false,0,true);
...
//                     "PMT_main_log_"+to_str(npm+1),                //its name                     
   ...
   G4PVPlacement* oil_phys = new G4PVPlacement(nullptr,{0,0,-box_front_cap_thick},oil_log,"oil_phys",m_Hexagone_log,false,0,true);
...
//     //placed in a few more lines
     ...
     new G4PVPlacement(pmt_flip, G4ThreeVector(0,0,-oil_hlength+pmt_glass_z_from_front),pmt_glass_log, "PMT_glass_phys",oil_log,false,0,true);    
   ...
   //----------------------------------------------------------------------------------------------------------------------
     ...
     G4PVPlacement* reflector_phys=new G4PVPlacement(pmt_flip,G4ThreeVector(0,0,-oil_hlength),reflector_log,"reflector_phys",oil_log,false,0,true);
